          ...
          <div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center gap-3 px-5 py-4 text-left bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors border border-gray-200 dark:border-gray-600"
              >
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200/50 dark:border-gray-600/50">
                ...
                {notificationPermission !== 'granted' && (
                  <button
                    ...
                    className="px-4 py-2 bg-gray-800 text-white text-sm rounded-lg hover:bg-gray-700 transition-colors dark:bg-gray-200 dark:text-gray-900 dark:hover:bg-gray-300"
                  >
                    开启通知
                  </button>
                )}
